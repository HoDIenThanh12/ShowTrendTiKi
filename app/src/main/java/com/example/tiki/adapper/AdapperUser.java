...
public class AdapperUser extends RecyclerView.Adapter<AdapperUser.AdapperUserViewHolder>  {
    private Context mcontext;
    private List<User> lUser;

    public AdapperUser(Context mcontext) {
    ...
    @NonNull
    @Override
    public AdapperUserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_card_product,parent,false);
        return new AdapperUserViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapperUserViewHolder holder, int position) {
    ...
    public class AdapperUserViewHolder extends RecyclerView.ViewHolder {
